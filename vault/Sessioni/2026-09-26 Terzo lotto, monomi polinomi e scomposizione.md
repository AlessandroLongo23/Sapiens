...
- Le lezioni già pubblicate hanno lo stesso difetto delle formule larghe sul telefono (per esempio 8 formule su 22 in Operazioni tra monomi, 11 su 48 in Equazioni di primo grado): da sistemare con lo stesso metodo.
- Negli esercizi già pubblicati restano problemi e risposte troppo larghi per il telefono: il livello 5 di Espressioni con monomi sborda in tutti i problemi, e fino al 7% delle opzioni di Equazioni di secondo grado non sta nel pulsante. Da sistemare con le stesse misure; i brief dei lotti futuri devono chiedere i due limiti (350 px per il problema, 252 px per l'opzione).
