...
- Il riepilogo della prova elenca gli errori: la domanda, la risposta data, quella giusta, e i passaggi con un tocco (`RunMistakes.tsx`). Il ciclo delle domande è in `RunPlayer.tsx`, riusabile fuori dalla lezione. Funzione 1 di [[Progressi dello studente]].
