...
1. **Lotti nuovi**, uno alla volta, ciascuno completo di teoria, esercizi, formulario e flashcard. Il secondo (i capitoli dei numeri, 8 lezioni) è fatto e committato il 24 settembre. Il terzo (monomi, polinomi e scomposizione, 12 lezioni) è fatto il 26 settembre: 38 lezioni complete. Proposta per chiudere il primo anno, da confermare: insiemi, logica e funzioni (12); frazioni algebriche, equazioni e disequazioni (9); statistica e geometria (8). Vedi [[2026-09-26 Terzo lotto, monomi polinomi e scomposizione]]. La rilettura la fa Andrea (vedi [[2026-09-24 Contenuti scritti da Claude e rivisti da Andrea]]). Dal 25 settembre ogni lotto scrive anche i prerequisiti delle sue lezioni, e vanno aggiunti alle 26 già scritte (vedi [[2026-09-25 I prerequisiti si scrivono per lezione, con un solo tipo di arco]]). Il grafo del primo anno è scritto (`docs/lezioni/prerequisiti.md`, 26 settembre): ogni lotto nuovo aggiunge le sue righe e ricontrolla quelle delle lezioni che scrive. Restano da decidere il ripasso dopo il secondo errore e il prerequisito chiave per livello.
...
## Chiusi di recente
- 2026-09-26: terzo lotto, 12 lezioni di monomi, polinomi e scomposizione con 12 generatori, formulari e 229 flashcard; bug di `collect()` corretto; formule spezzate per il telefono. Vedi [[2026-09-26 Terzo lotto, monomi polinomi e scomposizione]].
