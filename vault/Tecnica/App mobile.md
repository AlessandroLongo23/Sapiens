...
## Stato attuale
- Dal 25 settembre 2026 (sera) l'app installata si apre su "Oggi" (`/oggi`, `APP_START`; anche `start_url` del manifest), non più sulla pagina di Matematica, che resta la scheda Materiale (`APP_LIBRARY`). La barra in basso dell'app ha cinque schede: Oggi, Materiale, Zaino, Ripetizioni, Profilo. Sul sito, a chi ha fatto l'accesso, Oggi prende il posto di Home nella barra del telefono e compare nell'intestazione e nel menu. "Oggi" mostra, in quest'ordine: la prova lasciata a metà oggi o ieri, la pratica del giorno, la serie di giorni, gli errori da rifare (il ripasso parte lì), il percorso della lezione più recente, le domande gratuite rimaste. Chi non ha un account vede l'invito a crearne uno e il link al materiale. Vedi [[2026-09-25 Oggi è lo schermo iniziale dell'app]] e [[Progressi dello studente]]. La grafica è da rifinire con Dario.
