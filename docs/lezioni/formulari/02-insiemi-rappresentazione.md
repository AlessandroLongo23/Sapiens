...
$$A = \{a, e, i, o, u\} \qquad \{2, 4, 6, 8\} = \{8, 2, 6, 4\}$$
...
$$\{x \in \mathbb{N} \mid x^2 = 4\} = \{2\} \qquad \{x \in \mathbb{Z} \mid x^2 = 4\} = \{-2, 2\}$$
...
$$\{3, 6, 9, 12, 15\} = \{x \in \mathbb{N} \mid x \text{ è multiplo di } 3 \text{ e } 1 \le x \le 15\}$$
