...
import { ArrowLeft, Hash, Type } from 'lucide-react';
 ...
 */
export function NoteHeader({ notebookId, notebookTitle, onModeChange }: { notebookId: string; notebookTitle: string; onModeChange: (mode: EditorMode) => void }) {
