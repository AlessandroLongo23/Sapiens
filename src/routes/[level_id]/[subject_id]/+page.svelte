			...
			>
				...
				<div class="flex items-start gap-4 sm:gap-6 mb-6">
					...
					<div class="flex-1">
						...
						>
							Esplora i contenuti didattici organizzati per capitoli. Trova teoria, esercizi
							e risorse per approfondire ogni argomento.
						</p>
					</div>
				</div>
					...
					<div class="flex items-center gap-2">
						...
						<div>
							...
							<div class="text-xs sm:text-sm text-zinc-600 dark:text-zinc-400">
								{subjectData.chapters.length === 1 ? 'Capitolo' : 'Capitoli'}
							</div>
						</div>
					</div>
			...
			{:else}
				...
				>
					...
					<p class="text-zinc-600 dark:text-zinc-400 max-w-md mb-6">
						Al momento non ci sono capitoli disponibili per questa materia. Torna presto per
						nuovi contenuti!
					</p>
					<button
