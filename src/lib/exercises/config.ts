...
export const configs: Record<string, LessonExercises> = {
	...
	'high_school/math/monomi-polinomi/monomi': { generator: 'monomi', levels: [1, 2, 3, 4, 5, 6] },
	'high_school/math/monomi-polinomi/polinomi': { generator: 'polinomi', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/monomi-polinomi/polinomi-operazioni': { generator: 'polinomi-operazioni', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/monomi-polinomi/polinomi-prodotti-notevoli': { generator: 'polinomi-prodotti-notevoli', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/monomi-polinomi/polinomi-espressioni': { generator: 'polinomi-espressioni', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/monomi-polinomi/polinomi-divisione': { generator: 'polinomi-divisione', levels: [1, 2, 3, 4, 5, 6] },
	'high_school/math/monomi-polinomi/polinomi-ruffini': { generator: 'polinomi-ruffini', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/scomposizione/scomposizione-raccoglimento': { generator: 'scomposizione-raccoglimento', levels: [1, 2, 3, 4, 5, 6] },
	'high_school/math/scomposizione/scomposizione-prodotti-notevoli': { generator: 'scomposizione-prodotti-notevoli', levels: [1, 2, 3, 4, 5, 6] },
	'high_school/math/scomposizione/scomposizione-trinomio': { generator: 'scomposizione-trinomio', levels: [1, 2, 3, 4, 5, 6, 7] },
	'high_school/math/scomposizione/scomposizione-ruffini': { generator: 'scomposizione-ruffini', levels: [1, 2, 3, 4, 5, 6] },
	'high_school/math/scomposizione/polinomi-mcd-mcm': { generator: 'polinomi-mcd-mcm', levels: [1, 2, 3, 4, 5, 6, 7] },
