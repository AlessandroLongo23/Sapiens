<script>
    ...
    import { updateStudent, deleteStudent } from '$lib/stores/students.svelte.js';
        ...
        <tbody>
            {#each sortedStudents as student (student.id)}
                <tr class="bg-white dark:bg-zinc-900 border-t border-zinc-500/25 dark:border-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-800/50">
                    <td class="px-6 py-2 font-medium text-zinc-900 dark:text-white whitespace-nowrap border-r border-zinc-200/50 dark:border-zinc-700/50">{student.first_name}</td>
                    <td class="px-6 py-2 border-r border-zinc-200/50 dark:border-zinc-700/50">{student.last_name}</td>
                    <td class="px-6 py-2 border-r border-zinc-200/50 dark:border-zinc-700/50">{student.level || 'N/A'}</td>
                    <td class="px-6 py-2 border-r border-zinc-200/50 dark:border-zinc-700/50">{student.city || 'N/A'}</td>
                    <td class="px-6 py-2 border-r border-zinc-200/50 dark:border-zinc-700/50">{student.lectures_done || 0}</td>
                    <td class="px-6 py-2 border-r border-zinc-200/50 dark:border-zinc-700/50">{student.phone || 'N/A'}</td>
