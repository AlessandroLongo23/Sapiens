...
<style lang="postcss">
	...
	:global(.markdown-content h2) {
		@apply text-4xl font-bold text-zinc-950 dark:text-white mb-10 mt-24 pb-4 border-b border-blue-400/80;
		scroll-margin-top: 1rem;
	}
	
	:global(.markdown-content h3) {
		@apply text-2xl font-semibold text-zinc-950 dark:text-white mb-4 mt-16 scroll-mt-20;
	}
	
	:global(.markdown-content h4) {
		@apply text-xl font-medium text-zinc-950 dark:text-white mb-3 mt-8 scroll-mt-16;
	}
	...
	:global(.markdown-content blockquote) {
		@apply border-l-4 border-blue-500/30 pl-4 italic text-zinc-400 my-4;
	}
