...
>
    <div class="flex items-center gap-4 min-w-0">
        <div class="flex items-center justify-center w-10 h-10 rounded-lg bg-zinc-100 dark:bg-zinc-800 text-zinc-500 group-hover:bg-rose-50 dark:group-hover:bg-rose-900/20 group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors">
             <result.subject.icon size={18} />
        </div>
        <div class="flex flex-col min-w-0 gap-0.5">
            <span class="text-base font-semibold text-zinc-900 dark:text-zinc-100 group-hover:text-rose-600 dark:group-hover:text-rose-400 transition-colors truncate">
    ...
    <div class="text-zinc-300 dark:text-zinc-600 group-hover:text-rose-400 dark:group-hover:text-rose-600 group-hover:translate-x-0.5 transition-all">
