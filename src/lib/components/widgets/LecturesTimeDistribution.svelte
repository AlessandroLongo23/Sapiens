<script>
	...
	let svg;
	let width;
	let height = 300; // Fixed height for the chart area - taller for better mobile view
	...
	// Process data to get hour distribution
	let hourlyDistribution = $derived.by(() => {
		// Initialize hours array with 0 counts (6 AM to 10 PM = 17 hours)
	...
	function createChart() {
		...
		// Increase margins for better mobile view
