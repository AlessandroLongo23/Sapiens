...
{#if isOpen}
	...
	>
		<div
			...
			tabindex="-1"
			onkeydown={() => {}}
			class="bg-white rounded-2xl sm:rounded-3xl shadow-2xl w-full max-w-4xl h-[90vh] sm:h-[85vh] flex flex-col border border-zinc-100/60 transform transition-all duration-500 scale-100"
