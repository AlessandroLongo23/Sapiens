	...
	<div class="relative flex flex-col p-5 sm:p-6">
		...
		<div class="flex items-start justify-between mb-3">
			{#if chapter.icon}
				...
				<div
					class="p-2.5 rounded-lg bg-gradient-to-br from-rose-500/10 to-rose-500/5 dark:from-rose-500/20 dark:to-rose-500/10 group-hover:from-rose-500/20 group-hover:to-rose-500/10 dark:group-hover:from-rose-500/30 dark:group-hover:to-rose-500/20 transition-all duration-300"
				>
					<ChapterIcon
