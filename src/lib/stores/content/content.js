...
// Create a derived store that transforms the flat node structure to the legacy nested format
...
export const legacyContentStructure = createLegacyStructureStore();