			...
			},
			{
				...
				chapters: [
					...
					{ id: 'elementi-composti', name: 'Elementi e composti', icon: "Beaker", topics: [
						{ id: 'elementi-"Atom"ici', name: 'Elementi, "Atom"i e molecole' },
	...
	},
	{
		...
		subjects: [
			...
			},
			{
				...
				chapters: [
					...
					{ id: 'fisica-moderna', name: 'Fisica moderna', icon: "Atom", topics: [
						{ id: 'modello-"Atom"ico', name: 'Modelli "Atom"ici' }
					] },
			...
			},
			{
				...
				icon: "Beaker",
				chapters: [
					{ id: '"Atom"o-struttura', name: 'Struttura dell\'"Atom"o', icon: "Beaker", topics: [
						{ id: 'particelle-fondamentali', name: 'Protoni, neutroni ed elettroni' },
						{ id: 'numero-massa', name: 'Numero "Atom"ico e numero di massa' }
					] },
					{ id: 'tavola-periodica', name: 'Tavola periodica', icon: "Beaker", topics: [
